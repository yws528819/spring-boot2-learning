...
import com.yws.interceptor.LoginInterceptor;
import com.yws.interceptor.RedisUrlCountInterceptor;
...
public class AdminWebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new LoginInterceptor())
                ...
                .excludePathPatterns("/", "/login", "/css/**", "/fonts/**", "/images/**", "/js/**", "/aa/**", "/sql", "/city");//放行的请求
